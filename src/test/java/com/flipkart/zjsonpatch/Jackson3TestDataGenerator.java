...
/**
 * Jackson 3.x compatibility version of {@link TestDataGenerator}.
 * Generates test data using Jackson 3.x APIs for compatibility testing.
 * 
 * @author Mariusz Sondecki
 */
class Jackson3TestDataGenerator {
    ...
    static JsonNode generate(int count) {
